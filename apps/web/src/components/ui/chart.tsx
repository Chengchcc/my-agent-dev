...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  const chartStyleHtml = Object.entries(THEMES)
    .map(
      ([theme, prefix]) => `
...
`,
  ...
  return (
    // biome-ignore lint/security/noDangerouslySetInnerHtml: static CSS variables from predefined theme config
    <style dangerouslySetInnerHTML={{ __html: chartStyleHtml }} />
  );
};
