...
// ── SelectTrigger — same class set as before, split by concern ──────────────
...
const triggerInteraction =
  "focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20";
const triggerPlaceholder = "data-placeholder:text-muted-foreground";
const triggerSize =
...
// ── SelectContent — same class set as before, split by concern ──────────────
...
const contentAlign = "data-[align-trigger=true]:animate-none";
const contentSlides =
    ...
    <SelectPrimitive.Portal>
      ...
      >
        <SelectPrimitive.Popup
          ...
          className={cn(contentBase, contentAlign, contentSlides, contentAnimation, className)}
          {...props}
        >
...
// ── SelectItem — same class set as before, split by concern ─────────────────
...
const itemDisabled = "data-disabled:pointer-events-none data-disabled:opacity-50";
const itemSvg = "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4";
const itemTrailing = "*:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2";

function SelectItem({ className, children, ...props }: SelectPrimitive.Item.Props) {
  return (
    <SelectPrimitive.Item
      data-slot="select-item"
      className={cn(itemBase, itemFocus, itemDisabled, itemSvg, itemTrailing, className)}
      {...props}
    >
