  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          "fixed inset-y-0  z-50 flex w-64 flex-col overflow-y-auto bg-popover p-3 text-popover-foreground shadow-lg outline-none transition-transform duration-200",
          side === "right" &&
